...
Add CUDA and CUDA toolkit to a devcontainer (via apt)
...
|-----|-----|-----|-----|
| cudaVersion | The CUDA version to install (like 12.9) | string | undefined |
| architecture | The platform architecture to use | string | undefined |
| ubuntuVersion | The Ubuntu version to use | string | undefined |
| installCudnn | Additionally install CUDA Deep Neural Network (cuDNN) shared library | boolean | true |
...
| installToolkit | Additionally install NVIDIA CUDA Toolkit | boolean | true |
